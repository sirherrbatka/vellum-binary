...
(defun read-file-header (stream)
  ...
  (let ((version (nibbles:read-ub16/be stream)))
    (when (> version +version+)
      (error "File generated by newer version of VERSION-BINARY."))
    (when (< version +version+)
      (error "File generated by older version of VERSION-BINARY."))))
...
(defmethod read-elements-callback (column-type)
  (lambda (stream) (read-object stream)))


(defmethod write-elements-callback (column-type)
  (lambda (object stream) (write-object object stream)))
